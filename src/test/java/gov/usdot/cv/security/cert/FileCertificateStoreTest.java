...
public class FileCertificateStoreTest {
	...
	private static final String pcaCert = "@certificates/security-2016/trustedcerts/pca@";
	private static final String signingPrivateKey = "@certificates/security-2016/sign.prv@";
	private static final String selfCert = "@certificates/security-2016/downloadFiles/559f72e456956030.cert@";
	private static final String selfCertPrivateKeyReconstructionValue =
										"@certificates/security-2016/downloadFiles/559f72e456956030.s@";
	private static final String clientCert = "@certificates/security-2016/downloadFiles/fdd0a6aafb493c6d.cert@";
	private static final String clientCertPrivateKeyReconstructionValue =
										"@certificates/security-2016/downloadFiles/fdd0a6aafb493c6d.s@";
	...
	public void testPublicCertificateLoad() throws DecoderException, CertificateException, IOException,
		...
		FileCertificateStore.load(new CryptoProvider(), "PCA", pcaCert);
	...
	public void testFullCertificateLoad() throws DecoderException, CertificateException, IOException,
		...
		FileCertificateStore.load(new CryptoProvider(), "Self", 
															selfCert,
															selfCertPrivateKeyReconstructionValue,
															signingPrivateKey);
	...
	public void testValidateAndLog() throws ParseException, DecoderException, CertificateException, IOException,
		...
		FileCertificateStore.load(cryptoProvider, "PCA", pcaCert);
		FileCertificateStore.load(new CryptoProvider(), "Self", 
															selfCert,
															selfCertPrivateKeyReconstructionValue,
															signingPrivateKey);
		FileCertificateStore.load(new CryptoProvider(), "Client", 
															clientCert,
															clientCertPrivateKeyReconstructionValue,
															signingPrivateKey);
