...
public class Time64HelperTest {
	...
	public void testFixedValue(long fixedValue) {
		...
		bb.rewind();
		Time64 decodedFixedValue = new Time64(BigInteger.valueOf(bb.getLong()));
		...
		assertEquals(fixedValue, decodedFixedValue.bigIntegerValue().longValue());
		assertEquals(decodedFixedValue.bigIntegerValue().longValue()/1000,
					convertedFixedValue.bigIntegerValue().longValue()/1000);
	}
